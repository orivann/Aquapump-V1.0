export const translations = {
  nav: {
    ...
    sustainability: { en: 'Sustainability', he: 'קיימות' },
  ...
  sustainability: {
    title: { en: 'Sustainability Impact', he: 'השפעת קיימות' },
    energySavings: { en: 'Energy Savings', he: 'חיסכון באנרגיה' },
    co2Reduction: { en: 'CO₂ Reduction', he: 'הפחתת CO₂' },
    waterConservation: { en: 'Water Conservation', he: 'שימור מים' },
  },
  contact: {
    ...
    whatsapp: { en: 'Chat on WhatsApp', he: 'שוחח בוואטסאפ' },
  },
  chatbot: {
    greeting: {
  ...
  footer: {
    copyright: {
      en: '© 2025 AquaPump. All rights reserved.',
      he: '© 2025 AquaPump. כל הזכויות שמורות.',
    },
  },
};
